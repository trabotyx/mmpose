...
# runtime
train_cfg = dict(max_epochs=100, val_interval=1, dynamic_intervals=[(580, 1)])
...
# data
input_size = (640, 640)
metafile = '/home/slim/git/mmpose/configs/_base_/datasets/crop_weed.py'
...
data_mode = 'bottomup'
data_root = '/home/slim/git/trabotyx_dvc_plant_detection/data/'
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'test/coco_annotations.json',
    score_mode='bbox',
    nms_mode='none',
)
...
resume = False
load_from = "/home/slim/git/rtmo-s_8xb32-600e_coco-640x640-8db55a59_20231211.pth"